...
\item
Default style:\\
\verb+\input{tex/config/titlesec/default.tex}+

\item
Veelo chapter style:\\
\verb+\input{tex/config/titlesec/style1.tex}+

\item
Centered title within two rules:\\
\verb+\input{tex/config/titlesec/style2.tex}+

\item
Left-aligned title within two rules (no chapter number):\\
\verb+\input{tex/config/titlesec/style3.tex}+

\item
Title with a bottom rule:\\
\verb+\input{tex/config/titlesec/style4.tex}+

\item
Centered title within two rules (but unnumbered chapters have no rules):\\
\verb+\input{tex/config/titlesec/style5.tex}+
...
x = 1 + y
\end{equation}
\eqcaption{A title for the first equation.}

The equation below is not numbered and therefore cannot be referenced.
...
\end{equation}
\eqcaption{Another title for the second equation.}
