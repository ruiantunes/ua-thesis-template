...
% information: right position at even pages, left position at odd pages.
\setlength\headheight{16pt}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LO,RE]{\fontsize{12}{14.4}\textsc{\leftmark}}
\fancyhead[LE,RO]{\fontsize{12}{14.4}}

% To make the chapter name lowercase (see "fancyhdr" documentation).
