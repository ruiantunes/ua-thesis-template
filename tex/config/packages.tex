...
% \input{tex/config/titlesec/default.tex}
\input{tex/config/titlesec/style1.tex}
% \input{tex/config/titlesec/style2.tex}
% \input{tex/config/titlesec/style3.tex}
% \input{tex/config/titlesec/style4.tex}
% \input{tex/config/titlesec/style5.tex}

% To have access to the "\xpretocmd" command.
\usepackage{xpatch}

% Create a list of equations.
% Adapted from:
% https://latex.org/forum/viewtopic.php?t=428
% https://stackoverflow.com/questions/61517319/vertical-spacing-adjustment-between-different-chapters-labels-in-the-list-of-eq
% The option "titles" is required since we are using the "titlesec"
% package to customize the chapter style.
\usepackage[titles]{tocloft}

\newlistof[chapter]{equations}{equations.toc}{\mylistofequationsname}

\newcommand{\eqcaption}[1]{%
\addcontentsline{equations.toc}{equations}{\protect\numberline{\theequation}#1}\par}

% Default values of <indent> and <numwidth>.
\cftsetindents{equations}{1.5em}{2.3em}

% Adjust vertical spacing between equations of different chapters.
\makeatletter
\xpretocmd{\@chapter}{\addtocontents{equations.toc}{\protect\addvspace{10\p@}}}{}{}{}%
\makeatother
...
% \input{tex/config/biblatex/ieee.tex}
